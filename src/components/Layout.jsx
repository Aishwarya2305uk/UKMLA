...
const searchIndex = [
  ...
  { path: '/fees', title: 'UKMLA Fees', text: 'A complete breakdown of UKMLA fees, including the UKMLA exam fees for international students (IMGs) and UK medical students.' },
        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <ul className="footer-links">
              ...
              <li><Link to="/fees">UKMLA Fees</Link></li>
